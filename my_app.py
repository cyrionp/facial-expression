...
from blur_detection_fft import detect_blur
...
def prediction_processes(filename):
    ...
    if detections:
        for face in detections:
            ...
            if score >= 0.80:
                if detect_blur(UPLOADS_DIR+filename):
                    print("Resim bulanık, başka resim deneyin")
                    return "Resim bulanık, başka resim deneyin"
                else:
                    x, y, w, h = face["box"]
